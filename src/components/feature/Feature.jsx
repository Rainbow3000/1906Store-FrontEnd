...
const Feature = () => {
  ...
  return (
    <div className='feature-container'>
      <div onClick={()=>handleArrow("left")} className='feature-icon feature-icon-left'><ArrowBackIosIcon/></div>
        ...
        <div onClick={() => handleArrow("right")} className='feature-icon feature-icon-right '><ArrowForwardIosIcon/></div>
    </div>
  )
}
